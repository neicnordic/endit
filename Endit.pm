...
sub writeprom {
	...
	foreach my $k (sort keys %{$ref}) {
		# This is not really helpful for humans, but it avoids clashes
		# between help strings which would be generated by the node
		# exporter for different instances.
		print $fh "# HELP endit_${k} ENDIT $logname endit_${k} metric.\n";
